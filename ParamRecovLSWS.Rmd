...
temp <- tibble(agent_nr = agent, biasT, followBiasT, self, other, feedback, trial = seq(ntrials)) # HERE I SAVE ALSO OTHER; TO BETTER UNDERSTAND WHAT THE AGENT IS DOING (noise is removed)
