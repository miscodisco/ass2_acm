...
```{r}
#Priors
prior_mean_bias <- seq(0, 1, 0.25)
prior_sd_bias <- seq(0.1, 1, .3)
prior_mean_beta <- seq(0, 1, 0.25)
prior_sd_beta <- seq(0.1, 1, .3)
...
sim_d_and_fit <- function(prior_mean_bias, prior_sd_bias, prior_mean_beta, prior_sd_beta, prior_mean_conf, prior_sd_conf) {
    ...
    data <- list(n = 1200, h = d1$self, memory = d1$memory, other = d1$other, confidence = d1$confidence, prior_mean_bias = prior_mean_bias, prior_sd_bias = prior_sd_bias, prior_mean_beta = prior_mean_beta, prior_sd_beta = prior_sd_beta, prior_mean_conf = prior_mean_conf, prior_sd_conf = prior_sd_conf)
