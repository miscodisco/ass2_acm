...
ggplot(draws_df) +
  geom_density(aes(fb_prior), fill = "blue", alpha = 0.3) +
  geom_density(aes(follow_bias), fill = "red", alpha = 0.3) +
...
ggplot(draws_df, aes(.iteration, confidencerate, group = .chain, color = .chain)) +
  geom_line() +
  theme_classic()
...
ggplot(draws_df) +
  geom_histogram(aes(prior_preds_m03_c05), color = "lightblue", fill = "blue", alpha = 0.3, bins = 90) +
  geom_histogram(aes(posterior_preds_m03_c05), color = "darkblue", fill = "blue", alpha = 0.3, bins = 90)+
  xlab("Predicted right hand choices") +
  ylab("Posterior Density") +
  theme_classic() + ggtitle('Prior and posterior predictions - memory = 0.3, confidence = 0.5')

ggplot(draws_df) +
  geom_histogram(aes(prior_preds_m03_c03), color = "lightblue", fill = "blue", alpha = 0.3, bins = 90) +
  geom_histogram(aes(posterior_preds_m03_c03), color = "darkblue", fill = "blue", alpha = 0.3, bins = 90)+
  xlab("Predicted right hand choices") +
  ylab("Posterior Density") +
  theme_classic() + ggtitle('Prior and posterior predictions - memory = 0.3, confidence = 0.3')

ggplot(draws_df) +
  geom_histogram(aes(prior_preds_m03_c09), color = "lightblue", fill = "blue", alpha = 0.3, bins = 90) +
  geom_histogram(aes(posterior_preds_m03_c09), color = "darkblue", fill = "blue", alpha = 0.3, bins = 90)+
  xlab("Predicted right hand choices") +
  ylab("Posterior Density") +
  theme_classic() + ggtitle('Prior and posterior predictions - memory = 0.3, confidence = 0.9')
...
ggplot(draws_df) +
  geom_histogram(aes(prior_preds_m07_c05), color = "lightblue", fill = "blue", alpha = 0.3, bins = 90) +
  geom_histogram(aes(posterior_preds_m07_c05), color = "darkblue", fill = "blue", alpha = 0.3, bins = 90)+
  xlab("Predicted heads out of 120 trials") +
  ylab("Posterior Density") +
  theme_classic() + ggtitle('Prior and posterior predictions - memory = 0.7, confidence = 0.5')

ggplot(draws_df) +
  geom_histogram(aes(prior_preds_m07_c03), color = "lightblue", fill = "blue", alpha = 0.3, bins = 90) +
  geom_histogram(aes(posterior_preds_m07_c03), color = "darkblue", fill = "blue", alpha = 0.3, bins = 90)+
  xlab("Predicted heads out of 120 trials") +
  ylab("Posterior Density") +
  theme_classic() + ggtitle('Prior and posterior predictions - memory = 0.7, confidence = 0.3')

ggplot(draws_df) +
  geom_histogram(aes(prior_preds_m07_c09), color = "lightblue", fill = "blue", alpha = 0.3, bins = 90) +
  geom_histogram(aes(posterior_preds_m07_c09), color = "darkblue", fill = "blue", alpha = 0.3, bins = 90)+
  xlab("Predicted heads out of 120 trials") +
  ylab("Posterior Density") +
  theme_classic() + ggtitle('Prior and posterior predictions - memory = 0.7, confidence = 0.9')
...
ggplot(draws_df) +
  geom_histogram(aes(prior_preds_m13_c05), color = "lightblue", fill = "blue", alpha = 0.3, bins = 90) +
  geom_histogram(aes(posterior_preds_m13_c05), color = "darkblue", fill = "blue", alpha = 0.3, bins = 90)+
  xlab("Predicted heads out of 120 trials") +
  ylab("Posterior Density") +
  theme_classic() + ggtitle('Prior and posterior predictions - memory = 1.3, confidence = 0.5')

ggplot(draws_df) +
  geom_histogram(aes(prior_preds_m13_c03), color = "lightblue", fill = "blue", alpha = 0.3, bins = 90) +
  geom_histogram(aes(posterior_preds_m13_c03), color = "darkblue", fill = "blue", alpha = 0.3, bins = 90)+
  xlab("Predicted heads out of 120 trials") +
  ylab("Posterior Density") +
  theme_classic() + ggtitle('Prior and posterior predictions - memory = 1.3, confidence = 0.3')

ggplot(draws_df) +
  geom_histogram(aes(prior_preds_m13_c09), color = "lightblue", fill = "blue", alpha = 0.3, bins = 90) +
  geom_histogram(aes(posterior_preds_m13_c09), color = "darkblue", fill = "blue", alpha = 0.3, bins = 90)+
  xlab("Predicted heads out of 120 trials") +
  ylab("Posterior Density") +
  theme_classic() + ggtitle('Prior and posterior predictions - memory = 1.3, confidence = 0.9')
